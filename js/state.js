...
const state = {
    ...
    battleActive: false,
    canPlay: true,
    playerBlockedDrawThisTurn: false,
    mapNodes: [],
...
const RELIC_DATA = {
    'bracelet': { name: 'Bracelete da Boa Sorte', icon: '📿', effect: '1x por turno: Transforma as cartas do grimório na mão em coringas temporários, mantendo os efeitos.', lore: 'Um bracelete tecido com fios de ouro e trevos de quatro folhas que atrai a fortuna nos momentos críticos.' },
    ...
    'math_prime': { name: 'Pergaminho Primo', icon: '📜', effect: 'Cura 4 HP ao comprar cartas Primas (2,3,5,7).', lore: 'A ordem secreta dos números puros indivisíveis, cujas frequencies ressoam com energias regenerativas.' },
...
let usedBraceletThisTurn = false;
...
const SKILL_TREE = {
    ...
    spikes: { name: "Espinhos de Aço", description: "Inicia todas as batalhas com Espinhos de ferro", maxLevel: 4, costs: [30, 60, 120, 240], values: [2, 4, 6, 8] },
    ...
    hand_size: { name: "Grimório Rúnico", description: "Aumenta o limite de cartas que você pode segurar na mão (máx. 5)", maxLevel: 4, costs: [80, 150, 250, 400], values: [2, 3, 4, 5] }
};
