...
const RELIC_DATA = {
    ...
    'phoenix_feather': { name: 'Pena de Fênix', icon: '🪶', effect: 'Ressuscita uma vez por combate com 25% HP ao sofrer dano letal.' },
    'dice': { name: 'Dado Viciado', icon: '🎲', effect: 'Início do turno: 15% de chance de mudar o Slot Dourado.' },
    'runic_anvil': { name: 'Bigorna Rúnica', icon: '⚒️', effect: 'Cartas melhoradas (+) ganham +3 de poder.' },
    'cauldron': { name: 'Caldeirão Rúnico', icon: '🥣', effect: 'Toda vez que você curar HP, causa 3 de dano ao inimigo.' },
    'spiked_collar': { name: 'Coleira de Espinhos', icon: '🐕', effect: 'Espinhos retaliam 1.5x mais de dano.' },
    'toxic_gland': { name: 'Glândula Tóxica', icon: '🧪', effect: 'Sempre que aplicar Veneno, aplica +1 de Veneno adicional.' }
};
